...
const int BASKET_ZONE4_MAX  = (ONE_REVOLUTION/(PI * WHEEL_DIAMETER)) * -52 ;
...
void PointTurnLeft(int Seconds)
{
		motor[motorRight] = 55;
		motor[motorLeft] = -55;
		wait1Msec(Seconds);
...
task main()
{
  ...
  nMotorEncoderTarget[motorRight] =  currentTicks + 200;
	nMotorEncoderTarget[motorLeft] =  currentTicks + 200;
