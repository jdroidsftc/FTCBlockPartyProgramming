...
task Scoop()
{
	...
	while (1)
	{
		...
		//Scoop Down: fine control of the scoop going down
		if(joy2Btn(2) == 1)
		{
			servo[servoScoop] = ServoValue[servoScoop]  + 1;
		}
	  //Scoop UP: fine control of the scoop going up
		else if(joy2Btn(4) == 1)
		{
			servo[servoScoop] = ServoValue[servoScoop]  - 1;
		}
		...
		//Scoop Drop: positions the scoop drop position, all the way down
		else if(joy2Btn(1) == 1)
		{
